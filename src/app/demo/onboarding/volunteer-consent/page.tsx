  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-8 px-4" style={{ background: "#f5f0e3", fontFamily: "system-ui, sans-serif" }}>
      <div className="mb-6 text-center">
        ...
        <p className="text-xs text-gray-400 mt-1">Volunteer Consent — CareTaker Match Demo</p>
      </div>
        ...
        {submitted ? (
          <div className="px-5 py-10 flex flex-col items-center gap-4">
            {decision === "continue" ? (
              <>
                ...
                <div className="w-full rounded-xl p-4" style={{ background: CTM_GREEN }}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Jennifer W. — Your Patient</div>
                      <div className="text-xs" style={{ color: "rgba(255,255,255,0.7)" }}>Total Knee Replacement · Jun 18</div>
                      <div className="text-xs" style={{ color: "rgba(255,255,255,0.7)" }}>Chicago, IL · Lives alone</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full rounded-xl p-4" style={{ background: "#EAF3DE" }}>
                  ...
                  {[
                    "Contact info shared securely between you and Jennifer",
                    "Check in with Jennifer the day before surgery",
                    "3-day post-op visit schedule begins Jun 18",
                    "All communication monitored for safety",
                  ].map((item) => (
                ...
                <div className="w-full rounded-xl p-4 flex items-start gap-3" style={{ background: "white", border: `1.5px solid ${CTM_GOLD}` }}>
                  <span className="text-lg flex-shrink-0">⏰</span>
                  <div>
                    <div className="text-sm font-semibold" style={{ color: CTM_GOLD }}>Your Commitment</div>
                    <div className="text-xs mt-0.5" style={{ color: "#555" }}>
                      3 visits over 3 days post-surgery. Each visit is 2–4 hours. You can message Jennifer anytime through the secure proxy.
                    </div>
                  </div>
                </div>
              </>
              ...
              <>
                ...
                <div className="w-full rounded-xl p-4" style={{ background: "#EAF3DE" }}>
                  <div className="text-[10px] font-semibold uppercase tracking-wide mb-2" style={{ color: CTM_GREEN }}>What Happens Next</div>
                  {[
                    "Jennifer will be matched with another volunteer",
                    "You stay in the active volunteer pool",
                    "We'll reach out when another patient needs you",
            ...
            <div className="flex items-center justify-center gap-3 pt-4">
              <Link href="/demo/onboarding/patient-consent" className="text-xs hover:underline" style={{ color: CTM_GOLD }}>
                ← Patient&apos;s View
              </Link>
          ...
          <div className="px-4 py-5 flex flex-col gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs mt-1" style={{ color: "#73726c" }}>Your meet with Jennifer W. is complete</p>
            </div>

            {/* Jennifer summary card */}
            <div className="rounded-xl p-3 flex items-center gap-3" style={{ background: "white", border: "1px solid #e0d8c8" }}>
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: "#73726c" }}>Total Knee Replacement · Jun 18</div>
                <div className="text-xs" style={{ color: "#73726c" }}>Age 67 · Chicago, IL · Lives alone</div>
              </div>
            </div>

            {/* Decision question */}
            <div className="text-center">
              <p className="text-sm font-semibold" style={{ color: CTM_GREEN }}>Would you like to be Jennifer&apos;s CareTaker?</p>
              <p className="text-xs mt-1" style={{ color: "#73726c" }}>Both you and Jennifer must agree to move forward</p>
            </div>
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs mt-0.5" style={{ color: "#73726c" }}>
                  No judgment — the patient will be matched with someone else
                </div>
              </div>
            ...
            <div className="rounded-xl p-3.5 flex items-start gap-2.5" style={{ background: "#EBF4FF" }}>
              ...
              <p className="text-xs leading-relaxed" style={{ color: "#1e40af" }}>
                ...
                Jennifer won&apos;t know your decision until both of you have responded. If either person opts out, the match ends gracefully.
              </p>
            </div>

            {/* Optional feedback for opt-out */}
            {decision === "optout" && (
              <div className="rounded-xl p-4" style={{ background: "white", border: "1px solid #e0d8c8" }}>
                <div className="text-sm font-semibold mb-2" style={{ color: CTM_GREEN }}>Help us improve (optional)</div>
                <textarea
                  className="w-full rounded-lg p-3 text-sm resize-none focus:outline-none focus:ring-2"
                  style={{ border: "1px solid #e0d8c8", background: "#fafaf8", minHeight: 60 }}
                  placeholder="What didn't feel right? This helps us make better matches..."
                />
              </div>
            )}
            ...
            <Link href="/demo/onboarding/volunteer-confirmation" className="text-center text-xs hover:underline pb-2" style={{ color: CTM_GREEN }}>
              ← Back
            </Link>
          </div>
        )}
