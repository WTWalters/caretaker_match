...
export default function PatientWrapupPage() {
  const [personRating, setPersonRating] = useState(5);
  const [careRating, setCareRating] = useState(4);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-8 px-4" style={{ background: "#f5f0e3", fontFamily: "system-ui, sans-serif" }}>
      <div className="mb-6 text-center">
        ...
        <p className="text-xs text-gray-400 mt-1">Patient Wrap-up — CareTaker Match Demo</p>
      </div>
      ...
      <IPhone>
        ...
        {submitted ? (
          <div className="px-5 py-10 flex flex-col items-center gap-4">
            ...
            <h2 className="text-xl font-bold text-center" style={{ color: CTM_GREEN }}>Thank You, Jennifer!</h2>
            <p className="text-sm text-center leading-relaxed" style={{ color: "#555" }}>
              Your feedback helps us improve CareTaker Match for future patients. We wish you a smooth recovery!
            </p>
            {stayConnected && (
            ...
            <div className="flex items-center justify-center gap-3 pt-4">
              <Link href="/demo/onboarding/volunteer-wrapup" className="text-xs hover:underline" style={{ color: CTM_GOLD }}>
                Volunteer&apos;s View →
              </Link>
          ...
          <div className="px-4 py-5 flex flex-col gap-5">
            ...
            {/* Star rating: care */}
            <div className="rounded-xl p-4" style={{ background: "white", border: "1px solid #e0d8c8" }}>
              <StarRating value={careRating} onChange={setCareRating} label="Rate the Care You Received" />
            </div>
            ...
            <div className="rounded-xl p-4" style={{ background: "white", border: "1px solid #e0d8c8" }}>
              ...
              <textarea
                ...
                style={{ border: "1px solid #e0d8c8", background: "#fafaf8", minHeight: 80, focusRingColor: CTM_GREEN } as React.CSSProperties}
                placeholder="Share your thoughts — what worked, what didn't, what would make it better..."
                value={feedback}
